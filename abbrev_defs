...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ("ahk" "add-hook" nil :count 8)
    ("atl" "add-to-list" nil :count 9)
    ("bbf" "bury-buffer" nil :count 0)
    ("bfn" "buffer-file-name" nil :count 27)
    ("blp" "buffer-live-p" nil :count 2)
    ("blv" "buffer-local-value" nil :count 4)
    ("bn" "buffer-name" nil :count 11)
    ("bnp" "boundp '" nil :count 2)
    ("bsn" "buffer-substring-no-properties" nil :count 15)
    ("bss" "buffer-substring" nil :count 0)
    ("cbf" "current-buffer" nil :count 11)
    ("cldb" "cl-destructuring-bind" nil :count 1)
    ("df" "defun" nil :count 145)
    ("dfa" "defalias" nil :count 13)
    ("dfc" "defcustom" nil :count 4)
    ("dfk" "define-key" nil :count 9)
    ("dfm" "defmacro" nil :count 0)
    ("dfv" "defvar" nil :count 24)
    ("ef" "executable-find" nil :count 9)
    ("efn" "expand-file-name" nil :count 65)
    ("exf" "executable-find" nil :count 1)
    ("fep" "file-exists-p" nil :count 12)
    ("ff" "find-file" nil :count 0)
    ("ffn" "find-file-noselect" nil :count 2)
    ("fmt" "format \"\"" nil :count 4)
    ("fnb" "fboundp '" nil :count 0)
    ("fnd" "file-name-directory" nil :count 10)
    ("fne" "file-name-extension" nil :count 2)
    ("fnnd" "file-name-nondirectory" nil :count 3)
    ("fns" "file-name-split" nil :count 1)
    ("fnse" "file-name-sans-extension" nil :count 4)
    ("frn" "file-relative-name" nil :count 6)
    ...
    ("gc" "goto-char" nil :count 65)
    ("genv" "getenv" nil :count 4)
    ("gsk" "global-set-key " nil :count 0)
    ("ifc" "insert-file-contents" nil :count 5)
    ("ii" "interactive" nil :count 53)
    ("kyg" "keymap-global-set" nil :count 5)
    ("kyl" "keymap-local-set" nil :count 1)
    ("kys" "keymap-set" nil :count 14)
    ("kyu" "keymap-unset" nil :count 5)
    ("lbp" "line-beginning-position" nil :count 11)
    ("len" "length" nil :count 5)
    ("lep" "line-end-position" nil :count 6)
    ("luef" "locate-user-emacs-file" nil :count 4)
    ("mb" "match-beginning" nil :count 10)
    ("mcr" "mapcar" nil :count 8)
    ("mct" "mapconcat" nil :count 1)
    ("me" "match-end 0" nil :count 3)
    ("ms" "match-string 0" nil :count 8)
    ("msg" "message \"%s\"" nil :count 5)
    ("msn" "match-string-no-properties" nil :count 17)
    ...
    ("oeap" "org-element-at-point" nil :count 3)
    ("oep" "org-element-property" nil :count 7)
    ("oet" "org-element-type" nil :count 1)
    ("plg" "plist-get" nil :count 35)
    ("plp" "plist-put" nil :count 14)
    ("pm" "point-min" nil :count 25)
    ("px" "point-max" nil :count 21)
    ...
    ("wcb" "with-current-buffer" nil :count 53)
    ("weal" "with-eval-after-load" nil :count 4)
    ("wtb" "with-temp-buffer" nil :count 29)
