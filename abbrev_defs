...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ...
    ("fnd" "file-name-directory" nil :count 14)
    ...
    ("fnse" "file-name-sans-extension" nil :count 8)
    ...
    ("gc" "goto-char" nil :count 96)
    ("genv" "getenv" nil :count 5)
    ("gpm" "goto-char (point-min)" nil :count 3)
    ("gsk" "global-set-key " nil :count 0)
    ("ifc" "insert-file-contents" nil :count 10)
    ("ii" "interactive" nil :count 67)
    ...
    ("msn" "match-string-no-properties" nil :count 23)
