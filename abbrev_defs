...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ...
    ("mcr" "mapcar" nil :count 21)
    ("mct" "mapconcat" nil :count 2)
    ("med" "match-end" nil :count 1)
    ("msg" "message \"%s\"" nil :count 17)
    ("msn" "match-string-no-properties" nil :count 19)
    ...
    ("rris" "replace-regexp-in-string" nil :count 5)
    ...
    ("wcb" "with-current-buffer" nil :count 58)
