...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ...
    ("ahk" "add-hook" nil :count 12)
    ("alg" "alist-get" nil :count 3)
    ("atl" "add-to-list" nil :count 11)
    ("bbf" "bury-buffer" nil :count 0)
    ("bfn" "buffer-file-name" nil :count 41)
    ("blp" "buffer-live-p" nil :count 2)
    ("blv" "buffer-local-value" nil :count 8)
    ("bn" "buffer-name" nil :count 12)
    ("bnp" "boundp '" nil :count 2)
    ("bsn" "buffer-substring-no-properties" nil :count 23)
    ("bss" "buffer-substring" nil :count 0)
    ("cbf" "current-buffer" nil :count 20)
    ("cldb" "cl-destructuring-bind" nil :count 3)
    ("df" "defun" nil :count 203)
    ("dfa" "defalias" nil :count 13)
    ("dfc" "defconst" nil :count 13)
    ("dfk" "define-key" nil :count 9)
    ("dfm" "defmacro" nil :count 0)
    ("dfs" "define-skeleton" nil :count 3)
    ("dfu" "defcustom" nil :count 7)
    ("dfv" "defvar" nil :count 37)
    ("dvl" "defvar-local" nil :count 6)
    ("ef" "executable-find" nil :count 9)
    ("efn" "expand-file-name" nil :count 86)
    ("exf" "executable-find" nil :count 1)
    ("fep" "file-exists-p" nil :count 29)
    ("ff" "find-file" nil :count 0)
    ("ffn" "find-file-noselect" nil :count 2)
    ("ffns" "find-file-noselect" nil :count 1)
    ("fmt" "format \"\"" nil :count 14)
    ("fnb" "file-name-base" nil :count 4)
    ("fnd" "file-name-directory" nil :count 16)
    ("fne" "file-name-extension" nil :count 4)
    ("fnnd" "file-name-nondirectory" nil :count 10)
    ("fnp" "file-name-parent-directory" nil :count 1)
    ("fnpd" "file-name-parent-directory" nil :count 1)
    ("fns" "file-name-split" nil :count 1)
    ("fnse" "file-name-sans-extension" nil :count 9)
    ("frn" "file-relative-name" nil :count 10)
    ("frp" "file-readable-p " nil :count 0)
    ("fts" "format-time-string" nil :count 12)
    ("fu" "funcall" nil :count 0)
    ("gbc" "get-buffer-create" nil :count 21)
    ("gc" "goto-char" nil :count 104)
    ...
    ("nts" "number-to-string" nil :count 2)
    ...
    ("wcb" "with-current-buffer" nil :count 63)
    ("weal" "with-eval-after-load" nil :count 4)
    ("whl" "when-let" nil :count 1)
    ("wtb" "with-temp-buffer" nil :count 46)
