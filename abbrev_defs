...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ...
    ("bfn" "buffer-file-name" nil :count 35)
    ...
    ("rsf" "re-search-forward" nil :count 46)
    ...
    ("sq" "setq" nil :count 171)
    ("sqa" "shell-quote-argument" nil :count 4)
    ("sqf" "seq-filter" nil :count 16)
    ...
    ("wtb" "with-temp-buffer" nil :count 36)
...
(define-abbrev-table 'restclient-mode-abbrev-table
  '(
    ("ctj" "Content-Type: application/json" nil :count 4)
   ))
