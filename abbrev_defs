...
(define-abbrev-table 'emacs-lisp-mode-abbrev-table
  '(
    ...
    ("rsf" "re-search-forward" nil :count 34)
    ("se" "save-excursion" nil :count 25)
    ("sgb" "seq-group-by" nil :count 2)
    ("shq" "shell-quote-argument" nil :count 1)
    ...
    ("sq" "setq" nil :count 118)
    ("sqa" "shell-quote-argument" nil :count 2)
    ("sqf" "seq-filter" nil :count 9)
    ("sr" "save-restriction" nil :count 8)
