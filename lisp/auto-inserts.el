...
;; Auto-insert template definitions
...
(define-auto-insert
  ...
  '("Org file skeleton: "
    ...
    (file-relative-name
     (expand-file-name "org-includes/org.css" daily-home)
     default-directory)
    "\"></link>" \n
    "#+html_head: <link rel=\"stylesheet\" href=\""
    (file-relative-name
     (expand-file-name "org-includes/slideshow.css" daily-home)
     default-directory)
    "\"></link>" \n
    "#+html_head: <script src=\""
    (file-relative-name
     (expand-file-name "org-includes/org.js" daily-home)
     default-directory)
    "\"></script>" \n
    "#+html_head: <script src=\""
    (file-relative-name
     (expand-file-name "org-includes/slideshow.js" daily-home)
     default-directory)
    "\"></script>" \n
    "* " > _
    ))
