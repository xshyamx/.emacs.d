...
** Set the current position
   #+BEGIN_SRC emacs-lisp
     (setq default-frame-alist
           '((top . 23) (left . 912) (width . 108) (width . 35)))
...
** Plantuml
   #+BEGIN_SRC emacs-lisp
     (use-package plantuml-mode
       :ensure t
       :custom
       (plantuml-jar-path "/usr/local/Cellar/plantuml/1.2020.8/libexec/plantuml.jar" "Path to plantum.jar")
